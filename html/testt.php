...
<!-- Header -->
	...
	<div class="contactus" style="width:100%; margin:10px auto; border-radius: 12px;">
		...
		<header class="w3-center w3-margin-bottom"> 
		 ...
		 <div class="w3-row  w3-section">
			<div class="w3-col m4 w3-container">
			  <!-- Add Google Maps -->
			  <div id="map" class="w3-round-large w3-greyscale" style="width:100%;height:540px;"></div>
			</div>
			<div class="w3-col m8 w3-panel">
			  <div class="w3-large w3-margin-bottom" >
				<i class="fa fa-building fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> True Corporation Public Company Limited, <br>
				<span style="margin-left:50px;"> Customer Service Support. [ Facility Management ]<br></span>
				<i class="fa fa-map-marker fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Fl.21, Fortunetown, Ratchadaphisek Rd.,
					<br><span style="margin-left:50px;"> Khwaeng Din Daeng, Khet Din Daeng, </span><br> <span style="margin-left:50px;"> Bangkok 10400<br></span>
			  ...
			  <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
				...
				style="padding:8px; display:block; border:none; width:100%; height:70px;">
		...
		<script>
		function initMap() {
			var uluru = {lat:13.757692, lng: 100.564847};
